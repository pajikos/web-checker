...
public class SearchPageProcessorImplTest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SearchPageProcessorImplTest.class);
    ...
    @Test
    public void testProcessSeznamCz() throws Exception {
        SearchPage searchPage = new SearchPage("sreality", "http://localhost:8089/sreality.html");
        searchPage.setXpathToListOfResults(".//*[contains(concat(' ',normalize-space(@class),' '),' property ')]");
        ...
        LOG.info("Number of processed result from page {}: {}", searchPage.getUrl(), processed.size());
    ...
    @Test
    public void testJihoCeskeRealityCz() throws Exception {
        SearchPage searchPage = new SearchPage("jihoceskereality", "http://localhost:8089/jihoceskereality.html");
        searchPage
        ...
        searchPage.setOmitClassesInSearchResult("topovana, list_navigation, top_vypis2");
    ...
    @Test
    public void testParseRemaxCz() throws Exception {
        SearchPage searchPage = new SearchPage("Remax", "http://localhost:8089/Remax.html");
        searchPage.setXpathToListOfResults("/html/body/div[1]/div/div/div[1]/div[1]/div/ul/li");
    ...
    @Test
    public void testParseCentury21() throws Exception {
        SearchPage searchPage = new SearchPage("Century21", "http://localhost:8089/Century21.html");
        searchPage.setXpathToListOfResults(".//*[contains(concat(' ',normalize-space(@class),' '),' item ')]");
    ...
    @Test
    public void testParseRkStejskalCz() throws Exception {
        SearchPage searchPage = new SearchPage("RkStejskal", "http://localhost:8089/RkStejskal.html");
        searchPage
